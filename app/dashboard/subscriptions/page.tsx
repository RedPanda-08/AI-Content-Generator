...
export default function HomePage() {
  ...
  return (
    // FIX: Using min-h-[100dvh] for dynamic viewport height support
    <main className="min-h-[100dvh] bg-gradient-to-b from-black via-neutral-950 to-black text-white overflow-hidden">
      ...
      {/* Hero Section */}
      {/* FIX: Using min-h-[100dvh] here as well to ensure full screen fit on mobile */}
      <section className="relative flex flex-col items-center justify-center min-h-[100dvh] px-4 sm:px-6 pt-20 sm:pt-24 pb-12 sm:pb-16">
        <motion.div 
          initial="hidden"
          animate="visible"
